...
var ChatBox = function (_Component) {
    ...
    _createClass(ChatBox, [{
        ...
        value: function render() {
            var styleObj = { display: 'inline-block', padding: "12px", fontSize: window.innerHeight / 30, color: 'white', 'borderRadius': '5px' };
            ...
            return _react2.default.createElement(
                'div',
                { style: { clear: 'both', marginBottom: "20%" } },
    ...
    _createClass(ChatBoxAreaComponent, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_VideoInputComponent2.default, { ref: 'video', fromSrc: true, vidSrc: this.props.videosrc })
            );
        }
    }]);

    return ChatBoxAreaComponent;
}(_react.Component);

exports.default = ChatBoxAreaComponent;

},{"./ChatBox":1,"./VideoInputComponent":3,"react":29}],3:[function(require,module,exports){
"use strict";
    ...
    _createClass(VideoInputComponent, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                "div",
                { style: { width: "50%", height: "100%", float: 'left' } },
                _react2.default.createElement("video", { ref: "v", width: "100%", height: "100%", id: "video", autoPlay: true })
            );
        }
    }]);
...
var APP_ID = exports.APP_ID = '1bc1e2f8ce0b43289711654370cf93a8';
var SERVER = exports.SERVER = '';
var CHANNEL_KEY = exports.CHANNEL_KEY = 'AXBCD345ERPOX';
var CHANNEL = exports.CHANNEL = 'VIDEO_CHANNEL_SIGN_LANG';
...
var _ChatBoxAreaComponent = require('./components/ChatBoxAreaComponent');
...
var MainApp = function (_Component) {
    ...
    function MainApp(props) {
        ...
        _this.state = { chatMessagesSent: [], signImagesSent: [], chatMessagesReceived: [], signImagesReceived: ['a fine afternoon', 'do dinner'], videosrc: 'http://192.168.15.219:9000/common_sent/afternoon.mp4', vidSrc: '' };
        console.log(_this.props);
        return _this;
    }
    ...
    _createClass(MainApp, [{
        ...
        value: function componentDidMount() {
            ...
            this.agaroClient.init(_config.APP_ID, function () {
                console.log("agaro client initialized");
                _this2.agaroClient.join(null, _config.CHANNEL, null, function (uid) {
                    console.log("joined channel");
                    _this2.agaroClient.on('stream-added', function (evt) {
                        var stream = evt.stream;
                        _this2.agaroClient.subscribe(stream, function (err) {
                            console.log("error in joining stream");
                        });
                        _this2.agaroClient.on('stream-subscribed', function (evt) {
                            _this2.setState({ vidSrc: window.URL.createObjectURL(evt.stream.stream) });
                        });
                    });
                }, function () {});
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_ChatBoxAreaComponent2.default, { ref: 'cba', onClick: function onClick(value) {
                        return _this3.sendMessage(value);
                    }, sentMessages: this.state.chatMessagesSent,
...
},{"./components/ChatBoxAreaComponent":2,"./config":4,"react":29,"react-dom":26}],6:[function(require,module,exports){
/**
